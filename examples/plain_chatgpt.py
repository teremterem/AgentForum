...
async def openai_agent(ctx: InteractionContext, **kwargs) -> None:
    ...
    full_chat = await ctx.request_messages.amaterialize_full_history(follow_replies=True)
    # # TODO TODO TODO TODO TODO
    # print()
    # print()
    # pprint([msg.as_dict() for msg in full_chat])
    # print()
    # print()
...
async def main() -> None:
    ...
    try:
        while True:
            user_requests = user_proxy_agent.ask(
                assistant_responses,
                # reply_to=assistant_responses,  # TODO TODO TODO TODO TODO
            )
            ...
            assistant_responses = openai_agent.ask(
                ...
                stream=True,
                # reply_to=user_requests,  # TODO TODO TODO TODO TODO
            )

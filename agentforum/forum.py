...
from agentforum.models import Message, Freeform, AgentCallMsg, Immutable, MessageParams
...
class ConversationTracker:
    ...
    async def aappend_zero_or_more_messages(
        self, zero_or_more_msgs: MessageParams, forwarder_alias: str, do_not_forward_if_possible: bool = True
